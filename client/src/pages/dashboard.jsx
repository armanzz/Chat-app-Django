                ...
                <div className="col-md-6">
                    <div className="card">
                        <div className="card-body">
                            ...
                            <h5 className="header-title pb-3 mt-0">Add friends to start messaging {userEmail}!</h5>
                            <div
                ...
                <div className="col-md-6">
                    <div className="card">
                        <div className="card-body">
                            ...
                            <h5 className="header-title pb-3 mt-0">People you might know</h5>
                            {/* Add content here */}
                            <table className="table mb-0">
                                <tbody>
                                    {users
                                            ...
                                            <tr key={user.id}>
                                                ...
                                                <td className="border-top-0 text-right">
                                                    <button onClick={() => sendRequest(user.id)} className="btn btn-light btn-sm">
                                                        <i className="far fa-user mr-2 text-success"></i>Add Friend
                                                    </button>
                                                </td>
                                            </tr>
                                        ))
